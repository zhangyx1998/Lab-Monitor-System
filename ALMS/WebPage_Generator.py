...
def intp(CMD,index,row_count):
  ...
  else: return Err_exit_str+'<Table_Not_Found>#'+ CMD_table
        ...
        if (line==None or line==''):
          ...
          while (flag):
            ...
            while(line.count('#*')>0 and line.count('*#')>0):
              ...
              if replace_str.count(Err_exit_str)>0:
                flag=False
...
if __name__ == '__main__':
  ...
  parser.add_argument('--LogFile',      default='WPG_Logs.txt',      help='Target Version Control TXT file')
